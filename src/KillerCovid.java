...
public class KillerCovid extends JPanel implements ActionListener {
    ...
    //A class for image erro handling
    ...
    private void initialisedVariables() {
        ...
        timer = new Timer(60, this); //The images are redrawn every 60 milliseconds
        timer.start();
    }
    ...
    private void outputScore(){
        ...
        if(livesLeft == 0){
            ...
            try {
                ...
                List<String> lines = playerScore.stream().map(PlayerScores::toLine).collect(Collectors.toList());
    ...
    private void initialisedGame() {
        ...
        //Lives left is 3 and the players scoe starts at 0
        no_Viruses = 6;
        currentSpeed = 3;
        livesLeft = 3;
        score = 0;
